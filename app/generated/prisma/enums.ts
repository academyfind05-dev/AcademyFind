...
export const WalletTransactionSource = {
  ...
  DO_LIKE_REPLY_REVIEW: 'DO_LIKE_REPLY_REVIEW',
  REVIEW_LIKE_REPLY: 'REVIEW_LIKE_REPLY',
  REFERRAL: 'REFERRAL',
  PURCHASE: 'PURCHASE',
  AI_CHAT: 'AI_CHAT',
  DM_BOOST: 'DM_BOOST',
  ...
  SEE_CONTACT_BASIC_INSTITUTE: 'SEE_CONTACT_BASIC_INSTITUTE',
  MESSAGE_OTHER_USER: 'MESSAGE_OTHER_USER',
  RESUME_REVIEW: 'RESUME_REVIEW',
  INTERVIEW_GUIDANCE: 'INTERVIEW_GUIDANCE',
  COLLEGE_COUNSELLING: 'COLLEGE_COUNSELLING',
  CARRIER_COUNSELLING: 'CARRIER_COUNSELLING',
  UPSC_STRATEGY_SESSION: 'UPSC_STRATEGY_SESSION',
  SEE_STUDENT_PROFILE_BASIC: 'SEE_STUDENT_PROFILE_BASIC',
  SEE_TEACHER_PROFILE_BASIC: 'SEE_TEACHER_PROFILE_BASIC',
  VERIFY_MOBILE: 'VERIFY_MOBILE',
  SEE_COMMUNITY_BASIC_INSTITUTE: 'SEE_COMMUNITY_BASIC_INSTITUTE'
} as const
